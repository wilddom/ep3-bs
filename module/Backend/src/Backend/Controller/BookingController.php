            ...
            if ($editForm->isValid()) {
                ...
                if ($d['bf-rid']) {
                    ...
                    $savedBooking = $this->backendBookingUpdate($d['bf-rid'], $d['bf-user'], $d['bf-time-start'], $d['bf-time-end'], $d['bf-date-start'],
                        $d['bf-sid'], $d['bf-status-billing'], $d['bf-quantity'], $d['bf-notes'], $d['bf-team'], $params['editMode'], $d['bf-type'], $d['bf-custom-name']);
                    ...
                    $savedBooking = $this->backendBookingCreate($d['bf-user'], $d['bf-time-start'], $d['bf-time-end'], $d['bf-date-start'], $d['bf-date-end'],
                        $d['bf-repeat'], $d['bf-sid'], $d['bf-status-billing'], $d['bf-quantity'], $d['bf-notes'], $d['bf-team'], $sessionUser->get('alias'), $d['bf-type'], $d['bf-custom-name']);
                }
